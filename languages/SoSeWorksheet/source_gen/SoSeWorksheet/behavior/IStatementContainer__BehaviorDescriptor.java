...
public final class IStatementContainer__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0xc0ccb3a7555a492dL, 0x87ab866148bc2243L, 0x152e385bedc6a8a6L, "SoSeWorksheet.structure.IStatementContainer");

  public static final SMethod<Iterable<SNode>> getStatements_id1kIe5JHLFKT = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("getStatements").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1kIe5JHLFKT").build();
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, final SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.IVariable$Ud)) {
      ListScope variables = ListScope.forNamedElements(Sequence.fromIterable(SNodeOperations.ofConcept(IStatementContainer__BehaviorDescriptor.getStatements_id1kIe5JHLFKT.invoke(__thisNode__), CONCEPTS.IVariable$Ud)).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return SNodeOperations.getIndexInParent(it) < SNodeOperations.getIndexInParent(child);
        }
      }));
      return new HidingByNameScope(CONCEPTS.IVariable$Ud, kind, variables, ScopeUtils.lazyParentScope(__thisNode__, kind));
    }
    return null;
  }
  /*package*/ static Scope getScope_id52_Geb4QFgX(@NotNull SNode __thisNode__, SAbstractConcept kind, SContainmentLink link, final int index) {
    ...
    return ((Scope) ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QFgX.invokeSuper(__thisNode__, CONCEPTS.IStatementContainer$4L, kind, link, ((int) index)));
  }

  /*package*/ IStatementContainer__BehaviorDescriptor() {
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SInterfaceConcept IStatementContainer$4L = MetaAdapterFactory.getInterfaceConcept(0xc0ccb3a7555a492dL, 0x87ab866148bc2243L, 0x152e385bedc6a8a6L, "SoSeWorksheet.structure.IStatementContainer");
  }
}
